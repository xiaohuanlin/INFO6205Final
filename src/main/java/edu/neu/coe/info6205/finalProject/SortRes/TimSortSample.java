...
public class TimSortSample {
    ...
    public static void sort(String name,String location) throws IOException {
        Config config = Config.load(TimSortSample.class);
    ...
    public static void Configuration(List<String> list,List<String> location){
        ...
        location.add("src/main/java/edu/neu/coe/info6205/finalProject/SortRes/TimSortRes");
